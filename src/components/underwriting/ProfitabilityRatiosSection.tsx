...
interface ProfitabilityRatiosSectionProps {
  criteria: Criterion[];
  groupIndex: number;
...
export const ProfitabilityRatiosSection: React.FC<ProfitabilityRatiosSectionProps> = ({
  criteria,
  groupIndex,
  ...
  return (
    <Collapsible className="border border-gray-800 rounded-md p-4 space-y-2">
      <CollapsibleTrigger className="flex items-center justify-between w-full">
        <h4 className="text-sm font-medium">Profitability Ratios</h4>
