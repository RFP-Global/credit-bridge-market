          ...
          <div className="data-row whitespace-nowrap flex-shrink-0" style={{ animationDelay: "0s" }}>
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex animate-data-stream">
                ...
                <span className="data-item text-xs font-mono text-primary"><FileText className="h-3 w-3 inline mr-1" /> FACILITY_TYPE: ACQUISITION LOAN • APR: 9.1% • AMOUNT: $4.5M • TERM: 84M</span>
                <span className="data-item text-xs font-mono"><Search className="h-3 w-3 inline mr-1" /> INDUSTRY: RETAIL • REVENUE: $7.3M • EBITDA: $1.1M</span>
                <span className="data-item text-xs font-mono text-primary"><BarChart3 className="h-3 w-3 inline mr-1" /> FACILITY_TYPE: BRIDGE LOAN • APR: 10.2% • AMOUNT: $1.8M • TERM: 24M</span>
                <span className="data-item text-xs font-mono"><Search className="h-3 w-3 inline mr-1" /> INDUSTRY: REAL ESTATE • REVENUE: $3.9M • EBITDA: $2.2M</span>
              </div>
            ))}
          </div>
        </div>
